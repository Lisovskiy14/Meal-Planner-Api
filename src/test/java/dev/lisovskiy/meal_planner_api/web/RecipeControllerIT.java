...
//        ));
        ...
        List<RecipeSummaryDto> expectedList = recipeEntities.stream()
    ...
    public void updateRecipeById_shouldUpdateAndReturnRecipe() {
        ...
        RecipeSummaryDto actualResult = GlobalExtractor.getObjectFromMvcResult(
                mvcResult, RecipeSummaryDto.class, objectMapper
        );

        RecipeSummaryDto expectedResult = new RecipeSummaryDto(
                actualResult.getId(),
                updatedTitle,
                updatedInstructions,
                updatedPrepTimeMinutes
        ...
        resultActions.andDo(document("update-recipe-by-id",
                resource(
                        ResourceSnippetParameters.builder()
                                ...
                                .responseSchema(Schema.schema("RecipeSummaryDto"))
                                .requestFields(
                                    RecipeDtoSnippetProvider.getUpdateRecipeDtoFields()
                                )
                                .responseFields(
                                        RecipeDtoSnippetProvider.getRecipeSummaryDtoFields()
                                )
                                .build()
                )
        ));
